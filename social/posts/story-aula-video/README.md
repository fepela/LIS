...
- **`opcao-A-fullbleed.mp4`** — vídeo ocupando a tela toda + scrim petróleo +
  textos por cima (badge, headline, selo exclusivo, CTA). Mais **cinematográfico
  e imersivo**. (preview: `preview-A.png`)
