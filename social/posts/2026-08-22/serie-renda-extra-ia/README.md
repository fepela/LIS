...
Esta peça foi montada para passar na revisão de anúncios. As decisões:

1. **Nenhuma cifra de ganho.** A política de *Práticas Comerciais Inaceitáveis* e a de *Alegações
   Enganosas* barram promessa de retorno financeiro específico. A peça fala em "renda extra
   mensal" como **meta do experimento**, nunca como resultado prometido a quem assiste.
2. **Bloco de transparência em tela** (13,5–19,5s), em corpo legível e não em letra miúda:
   *"É a nossa meta, não uma promessa. (…) Resultado não é garantido e depende de cada pessoa."*
3. **Sem atributos pessoais.** Nada de "você está desempregado?" ou similar — a política de
   *Atributos Pessoais* proíbe insinuar que se conhece a situação financeira de quem vê.
...
Começamos uma série ao vivo de 5 capítulos: montar uma renda extra com IA, do zero, em público. 🔷

O Capítulo 1 já aconteceu e está gravado na comunidade.

Nele a gente abriu o plano inteiro: o plano estratégico do negócio, o estudo de mercado (quem paga, quanto paga) e a conta na mesa — custo, preço e margem. Sem receita mágica, sem atalho.

O caminho é vender três serviços, usando o que ensinamos nos 7 capítulos da ChapterIA: Social Media, Influenciador Digital e Sites.

Semana que vem, Capítulo 2: criar a empresa. Nome, logo, site e Instagram. Depois disso, subir as campanhas e ir atrás do primeiro cliente.

Importante dizer: essa é a NOSSA meta, não uma promessa. Estamos testando ao vivo — pode dar certo ou não, e o processo fica registrado do mesmo jeito. Resultado depende de cada um.

O Capítulo 1 está na comunidade: link na bio. 👆

#IA #RendaExtra #InteligenciaArtificial #ChapterIA

## Texto do anúncio (versão para Meta Ads)

**Título:** Uma renda extra com IA, construída em público
**Texto principal:**
Começamos uma série ao vivo de 5 capítulos montando um negócio de serviços com IA — do plano
à primeira venda. O Capítulo 1 (plano estratégico e estudo de mercado) já está gravado na
comunidade ChapterIA.
Próximo capítulo: criar a empresa — nome, logo, site e Instagram.
Esta é a nossa meta, não uma promessa: resultados não são garantidos e dependem de cada pessoa.
**CTA:** Saiba mais
