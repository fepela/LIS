...
> na sua empresa, na sua carreira e na sua renda extra.*
...
| [`perfis/instagram.md`](perfis/instagram.md) | Setup do perfil de Instagram (bio, destaques) + plano dos 3 posts fixos |
...
- **Plataformas prioritárias:** partindo de Instagram + LinkedIn (ajustável).
- **Links de conversão:** inserir URL de checkout/landing quando disponível → marcados como `[LINK]`.
- **Data de lançamento e prazo do cupom:** marcados como `[DATA]` / `[PRAZO]`.
